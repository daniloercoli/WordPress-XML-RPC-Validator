		...
		toggle_advanced_settings : function( ) {
			jq('#xmlrpc_validator_advanced_settings' ).fadeToggle(function() {
				if( jq('#xmlrpc_validator_advanced_settings').is(':visible') ) {
					...
					jq('#xmlrpc_validator_advanced_settings_switcher' ).text( 'Less Options');
				}
				else {
				    // it's not visible so do something else
					jq('#xmlrpc_validator_advanced_settings_switcher' ).text( 'More Options');
				}
		  }
			);
		},
		toggle_log : function( ) {
			jq('#xmlrpc_validator_log' ).fadeToggle(function() {
				if( jq('#xmlrpc_validator_log').is(':visible') ) {
				    // it's visible, do something
					jq('#xmlrpc_validator_log_view_switcher' ).text( 'Hide Log');
				}
				else {
				    // it's not visible so do something else
					jq('#xmlrpc_validator_log_view_switcher' ).text( 'Show Log');
				}
		  }
			);
		},
